...
* [Spring Boot Maven Plugin Reference Guide](https://docs.spring.io/spring-boot/3.3.11-SNAPSHOT/maven-plugin)
* [Create an OCI image](https://docs.spring.io/spring-boot/3.3.11-SNAPSHOT/maven-plugin/build-image.html)
